    ...
    <main>
        ...
        <section>
            ...
            if (isset($_SESSION["player_choice"])) {
                ...
                echo "<style>#rock_paper_scissors_form { display: none; }
                .info_steenpapierschaar { display: none; }</style>";
                //zet de spelers zijn keuze in een variable voor later
                $selectedOption_1 = $_SESSION['player_choice'];
                //laat de keuze speler van zien  
                echo "<p class='choices'>Jouw keuze <b>:</b> $selectedOption_1 </p>";

                //maakt de keuze van computer aan en laat deze ook zien
                $computer = mt_rand(1, 3);
                if ($computer == 1) {
                    $computer_choice = "rock";
                    echo "<p class='choices'>Computers keuze <b>:</b> steen</p>";
                } elseif ($computer == 2) {
                    $computer_choice = "paper";
                    echo "<p class='choices'>Computers keuze <b>:</b> papier</p>";
                } elseif ($computer == 3) {
                    $computer_choice = "scissors";
                    echo "<p class='choices'>Computers keuze <b>:</b> schaar</p>";
                }
