    ...
    <main>
        <section>
            ...
            if (isset($_GET['lp'])) {
                ...
                if (!isset($_SESSION['gebruikteletters'])) { // isset = kijkt of de waarde in de array zit
                    $_SESSION['gebruikteletters'] = []; 
                }

                if (in_array($gebruikteletter, $_SESSION['gebruikteletters'])) { // in_array = kijkt of de waarde in de array zit
                    echo "De letter " . $gebruikteletter . " is al gebruikt."; // De letter is al gebruikt
                } else {
                    $_SESSION['gebruikteletters'][] = $gebruikteletter; 
                    $found = false;

                    for ($i = 0; $i < $maxletters; $i++) { 
                        if ($woord[$i] == $gebruikteletter) { // kijkt of er een letter is ingevoerd
